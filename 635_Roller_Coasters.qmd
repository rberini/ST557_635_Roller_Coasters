...
This section is taken from the original project documentation. That documentation can be found here: <https://cdn.instepwithdata.org/RollerCoasterInvestigationLessonPlanBite-sized.pdf>
...
This section is adapted from the original project documentation. That documentation can be found here: <https://cdn.instepwithdata.org/RollerCoasterInvestigationLessonPlanBite-sized.pdf>
...
-   Perform data validation and manipulation, and identify any quality issues or missing values
...
ggsave(
  "images/roller_coaster_boxplots.pdf",
  units = "cm",
  dpi = 320,
  width = 21,
  height = 15
...
ggsave(
  "images/roller_coaster_boxplots.eps",
  units = "cm",
  dpi = 320,
  width = 21,
  height = 15
...
ggsave(
  "images/roller_coaster_boxplots.png",
  units = "px",
  dpi = 320,
  width = 2646,
  height = 1890,
...
ggsave(
  "images/length_height_scatter.pdf",
  units = "cm",
  dpi = 320,
  width = 21,
  height = 15
...
ggsave(
  "images/length_height_scatter.eps",
  units = "cm",
  dpi = 320,
  width = 21,
  height = 15
...
ggsave(
  "images/length_height_scatter.png",
  units = "px",
  dpi = 320,
  width = 2646,
  height = 1890,
...
ggsave(
  "images/speed_duration_scatter.pdf",
  units = "cm",
  dpi = 320,
  width = 21,
  height = 15
...
ggsave(
  "images/speed_duration_scatter.eps",
  units = "cm",
  dpi = 320,
  width = 21,
  height = 15
...
ggsave(
  "images/speed_duration_scatter.png",
  units = "px",
  dpi = 320,
  width = 2646,
  height = 1890,
...
roller_coasters |>
  ...
  adorn_ns() |>
  adorn_title("Scale", placement = "combined") |>
  kable()
```
...
roller_coasters |>
  ...
  scroll_box(width = "380px", height = "135px") |>
  save_kable("images/scale_design_table.png", zoom = 3)
```
...
roller_coasters |>
  ...
  select(Coaster,
         ...
         NumberOfInversions,
         Design) |>
  rename(Inversions = NumberOfInversions) |>
...
roller_coasters |>
  ...
  select(Coaster,
         ...
         Design) |>
  rename(Inversions = NumberOfInversions) |>
  mutate(Coaster = str_trunc(Coaster, 12), Park = str_trunc(Park, 10)) |>
  arrange(desc(MaxHeight)) |>
  kable() |>
  kable_styling(font_size = 8,
                bootstrap_options = c("condensed", "striped")) |>
  scroll_box(width = "380px", height = "271px") |>
  save_kable("images/extreme_coasters_table.png", zoom = 3)
```
